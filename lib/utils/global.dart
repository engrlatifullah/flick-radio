...
import '../screens/custom_nav_bar/flick_magazine_screen/flick_magazine_screen.dart';
...
import '../screens/custom_nav_bar/schedule_screen/schedule_screen.dart';


int selectedIndex = 0;
final List<Widget> screens = [
  const HomeScreen(),
  const FlickMagazineScreen(),
  ...
  if(name == null || name.isEmpty){
   ...
   try {
     final Email email = Email(
       body: about,
       subject: name,
       recipients: ['hello@flick.fm'],attachmentPaths: [file!],
       isHTML: false,
     );
