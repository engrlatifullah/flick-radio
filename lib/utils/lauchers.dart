...
class AppLaunchers {
  static launchFacebook() async {
    const facebookAppUrl = 'https://www.facebook.com/flickradio'; // Your Facebook page URL
    const fallbackUrl = 'https://www.facebook.com/flickradio'; // The same URL as fallback
  ...
  static launchInstagram() async {
    const instagramAppUrl = 'https://www.instagram.com/flickradio'; // Your Instagram page URL
    const fallbackUrl = 'https://www.instagram.com/flickradio'; // The same URL as fallback
